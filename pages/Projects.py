...
st.markdown("<h5 style> Questions of Interest: </h5>", unsafe_allow_html=True)
...
st.subheader("UC Davis: Mechkeys Tier List (Excel/Google Sheets)")
st.image("images/mechkeys.jpg")
st.markdown("<h5 style> Brief Introduction</h5>", unsafe_allow_html=True)
st.markdown("This project was created for the UC Davis MechKeys Club. As a club officer, I wanted to create a project that combined both my love for mechanical keyboards with data science. The Google Sheet consists of the following:")
st.write("")
st.markdown("<h5 style>Spreadsheets</h5>", unsafe_allow_html=True)
st.markdown("**Description:** An introduction/guide to the page")
st.markdown("**What is a Keyboard Switch?:** A detailed explanation to all things related to mechanical keyboard switches")
st.markdown("**Switch Tier List:** A tier list of all of our clubs available switches for demo, ranked into 5 different tiers.")
st.markdown("**Switch Database:** A database of all the switches we have in our club, including various metrics like weight, type, price, and more.")
st.markdown("**Affliate Links:** A list of partners and their affliate links to help support the club.")
