...
st.markdown("**4. Can we group Spotify songs based on their features (Spotify Streams, Spotify Playlist Count, Spotify Popularity, Youtube Views, TikTok Views)? If so, how many groups are there and what are their characteristics?**")
st.markdown("**5. Can we predict the amount of Youtube Views based on Spotify Streams, TikTok Views, and if the track is explicit or not?**")
...
st.markdown("**There were too many questions to list but if you are interested:**")
st.link_button("View the Full 2nd Part of the Keyboard Project", "https://github.com/Alexdxe/keyboard-selfstudy/tree/main/Part%202/Attempt%202", type= "secondary")
st.write("")

st.markdown("<h10 style>Note: This part of the project took two seperate attempts to complete.</h10>", unsafe_allow_html=True)
st.link_button("Original Attempt", "https://github.com/Alexdxe/keyboard-selfstudy/tree/main/Part%202/Attempt%201", type= "secondary")
